    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_influence_score', models.DecimalField(decimal_places=2, help_text='Суммарный показатель влияния всех артефактов', max_digits=10, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Общий показатель влияния')),
