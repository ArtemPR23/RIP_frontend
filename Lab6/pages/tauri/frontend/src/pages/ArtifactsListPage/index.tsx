...
import {updateArtifactName} from "src/store/slices/artifactsSlice.ts";
...
const ArtifactsListPage = ({artifacts, setArtifact, isMock, setIsMock}:Props) => {
    ...
    const fetchArtifacts = async () => {
        try {
            ...
            const response = await fetch(`${env.VITE_API_URL}/api/artifacts/?title=${artifact_name.toLowerCase()}`)
